...
DROP_SETS = {
    "base": [],
    "drop_2020_2021": [2020, 2021],
    "drop_2020_2022": [2020, 2021, 2022],
    "drop_2014_2015": [2014, 2015],
}
...
def main():
    ...
    ap.add_argument("--out", type=str, default="outputs/tables/robustness_drop_years.csv")
    args = ap.parse_args()
    ...
    rows = []
    for label, years in DROP_SETS.items():
        d2 = df.copy()
        if years:
        ...
        for y in Y_LIST[1:]:
            ...
            rows.append(
                {
                    "drop_set": label,
                    "dropped_years": ",".join(map(str, years)),
                    "DV": y,
                    **t,
                }
            )
